...
// Product Data
const products = [
  { id: 1, name: "Full Cream Milk", price: "₹60/L", description: "Rich, creamy, and packed with essential nutrients.", image: "https://images.unsplash.com/photo-1550583724-b2692b85b150?auto=format&fit=crop&q=80&w=800", available: true },
  { id: 2, name: "Toned Milk", price: "₹50/L", description: "Perfect balance of nutrition and lightness for daily use.", image: "https://images.unsplash.com/photo-1563636619-e9143da7973b?auto=format&fit=crop&q=80&w=800", available: false },
  { id: 3, name: "Double Toned", price: "₹45/L", description: "Low fat milk ideal for fitness enthusiasts.", image: "https://images.unsplash.com/photo-1559598467-f8b76c8155d0?auto=format&fit=crop&q=80&w=800", available: false },
  { id: 4, name: "Flavoured Milk", price: "₹35/200ml", description: "Delicious organic flavors loved by kids.", image: "https://images.unsplash.com/photo-1528498033373-3c6c08e93d79?q=80&w=800&auto=format&fit=crop", available: false },
  { id: 5, name: "Paneer Fresh", price: "₹80/200g", description: "Soft, malai paneer made from 100% cow milk.", image: "https://images.unsplash.com/photo-1596797038595-13bb9705ce35?q=80&w=800&auto=format&fit=crop", available: true },
  { id: 6, name: "Desi Ghee", price: "₹600/500ml", description: "Traditional bilona ghee with rich aroma.", image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&q=80&w=800", available: true },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/hero-mana.png"
            alt="Farm-fresh milk bottles on a dairy farm"
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20">
          <div className="bg-black/20 backdrop-blur-md p-8 md:p-12 rounded-[2rem] border border-white/10 shadow-2xl">
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="text-5xl md:text-7xl font-display font-bold text-white mb-6 leading-tight drop-shadow-md"
            >
              Pure. Fresh. <br className="hidden md:block" />
              <span className="text-secondary drop-shadow-[0_4px_4px_rgba(0,0,0,0.4)]">Delivered Daily.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.4 }}
              className="text-lg md:text-2xl text-white/95 mb-0 max-w-2xl mx-auto text-balance font-medium"
            >
      ...
      <section className="relative z-20 -mt-16 mb-24 px-4">
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl p-6 md:p-10 border border-border/50">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 divide-x-0 md:divide-x divide-border">
            {[
              { icon: Droplet, text: "100% Pure Cow Milk", color: "text-primary" },
              { icon: ShieldCheck, text: "No Preservatives", color: "text-primary" },
              { icon: Sun, text: "Daily Morning Delivery", color: "text-secondary" },
              { icon: ThermometerSnowflake, text: "Always Fresh & Cold", color: "text-primary" },
            ].map((badge, idx) => (
              <div key={idx} className="flex flex-col items-center text-center px-4 group">
                <div className={`p-5 rounded-full bg-primary/5 mb-4 group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-300 ${badge.color}`}>
                  <badge.icon size={36} strokeWidth={2} />
                </div>
                <h3 className="font-bold text-foreground text-sm md:text-base leading-tight">{badge.text}</h3>
              </div>
            ))}
          </div>
        </div>
          ...
          >
            {products.map((product) => (
              <motion.div
                key={product.id}
                variants={fadeUp}
                className={`bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group border border-border/40 relative ${!product.available ? "opacity-75" : ""
                  }`}
              >
                <div className={`relative h-64 overflow-hidden ${!product.available ? "blur-[2px]" : ""}`}>
                ...
                {!product.available && (
                  <div className="absolute top-4 left-4 bg-red-500 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider z-10 shadow-lg animate-pulse">
                    Coming Soon
                  </div>
                )}

                <div className={`p-8 ${!product.available ? "blur-[1px]" : ""}`}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <img
                src="/about-mana.png"
                alt="Happy cows grazing on our organic pastures"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-background rounded-3xl overflow-hidden shadow-lg border border-border/50">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">1-3, Paipalli village, beside amma international schoool Venkatagirikota 517424, Chittoor AP</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-primary/10 p-4 rounded-full text-primary shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">+91 87121 31151<br />Mon-Sat: 8AM - 8PM</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-primary/10 p-4 rounded-full text-primary shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">manadairy2026@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="h-[400px] lg:h-auto w-full bg-gray-200">
              <iframe
                src={`https://www.google.com/maps?q=${encodeURIComponent("1-3, Paipalli village, beside amma international schoool Venkatagirikota 517424, Chittoor AP")}&output=embed`}
                width="100%"
                height="100%"
                style={{ border: 0 }}
